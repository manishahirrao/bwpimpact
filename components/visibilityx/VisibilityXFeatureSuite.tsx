...
export default function VisibilityXFeatureSuite() {
  ...
  return (
    <section ref={ref} className="py-12 md:py-24 bg-off-white">
      <div className="max-w-container mx-auto px-6">
        ...
        >
          <div className="inline-block bg-gold-primary rounded-2xl md:rounded-full px-8 py-6 md:py-8 shadow-lg max-w-full">
            <p className="text-navy-deep font-bold text-lg leading-tight md:leading-normal">
              Command elite enterprise brand positioning without a traditional studio price tag.
              <span className="block md:inline ml-0 md:ml-2 mt-3 md:mt-0 text-navy-deep/80 md:text-navy-deep">Packages start from just ₹5,999/-</span>
            </p>
          </div>
        </motion.div>
      </div>
