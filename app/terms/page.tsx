    ...
    <main>
      ...
      <section className="py-12 md:py-16">
        <div className="max-w-3xl mx-auto px-6 prose prose-gray max-w-none">
          ...
          <h2>1. Services</h2>
          <p>BWP IMPACT provides digital marketing consultation, content creation, performance marketing, AI solutions, and ImpactX AI podcast production services as described on this website.</p>
          <h2>2. Engagement</h2>
          ...
          <h2>7. Contact</h2>
          <p>For terms-related queries, email <a href="mailto:hello@bwpimpact.com" className="text-navy-primary underline">hello@bwpimpact.com</a>.</p>
        </div>
      </section>
      <Footer />
    </main>
